...
If you'd like to get in touch, feel free to reach out:<br>
Email: neloverar@gmail.com<br><br>

If you are a Flutter developer in Gaza who concentrates on clean code, I would appreciate it if you contact me via email by sending the word "number",, and I’d be happy to have a chat with you.<br><br>

If you want an application that can compete in the world of artificial intelligence, feel free to contact me to discuss the details.<br><br>

If you're a student interested in diving deeper into Flutter app development, I will be starting a Flutter course soon — and we’ll build amazing things together.<br>
Register here:<br>
https://forms.gle/RWKdAujXqR3uujnX8<br><br>

You're awesome just for thinking about it 👏<br><br>
...
Software Engineer passionate about building high-quality, scalable applications designed to last.<br>
I focus on writing clean, maintainable code and creating products that can adapt and remain relevant in the rapidly evolving world of Artificial Intelligence.<br>
If you're looking for an engineer who values clarity, performance, and long-term impact — I'd be happy to collaborate.<br><br>
...
1. Building Lists<br>
   • ListView<br>
   • ListView.builder<br>
   • SingleChildScrollView + Column<br><br>
